...
define("@scom/scom-emoji-picker/interface.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("@scom/scom-emoji-picker/emoji.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.colorsMapper = exports.emojis = exports.emojiCategories = void 0;
...
define("@scom/scom-emoji-picker/model.ts", ["require", "exports", "@scom/scom-emoji-picker/emoji.json.ts"], function (require, exports, emoji_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class EmojiModel {
        constructor() {
            ...
            this._currentColor = this.emojiColors[0];
        }
        get currentColor() {
        ...
        getEmojisByCategory(category) {
            if (!this.emojiCategoryMap[category]) {
                ...
                this.emojiCategoryMap[category] = emoji_json_1.emojis.filter(emoji => emoji.category === category);
            }
        ...
        searchEmojis(value) {
            ...
            const categoryName = emoji_json_1.emojiCategories.find(cate => cate.name.toLowerCase().includes(keyword))?.name;
            let data;
            if (categoryName) {
                data = this.emojiCategoryMap[categoryName];
            }
            else {
                data = emoji_json_1.emojis.filter(emoji => emoji.name.includes(keyword));
            }
            return this.filterEmojiByColor(data);
        }
    }
...
define("@scom/scom-emoji-picker/translations.json.ts", ["require", "exports"], function (require, exports) {
    ...
    exports.default = {
        ...
        "zh-hant": {
            ...
            "search_emoji": "搜尋表情符號",
            "search_results": "搜尋結果",
            "smileys_and_emotion": "笑臉與情感",
            "smileys_and_people": "笑臉與人物",
            "symbols": "符號",
        ...
        "vi": {
            ...
            "flags": "Cờ",
            "food_and_drink": "Thức ăn và Đồ uống",
            "objects": "Đối tượng",
            "recent": "Gần đây",
...
define("@scom/scom-emoji-picker", ["require", "exports", "@ijstech/components", "@scom/scom-emoji-picker/emoji.json.ts", "@scom/scom-emoji-picker/model.ts", "@scom/scom-emoji-picker/translations.json.ts"], function (require, exports, components_1, emoji_json_2, model_1, translations_json_1) {
    ...
    let EmojiPicker = class EmojiPicker extends components_1.Module {
        constructor() {
            super(...arguments);
        ...
        updateEmojiGroups() {
            for (let i = 1; i < emoji_json_2.emojiCategories.length; i++) {
                const category = emoji_json_2.emojiCategories[i];
        ...
        onRecentClear() {
            ...
            if (this.gridEmojiCate?.children[1]) {
                this.onEmojiCateSelected(this.gridEmojiCate.children[1], emoji_json_2.emojiCategories[1]);
            }
        }
        renderEmojiColors() {
        ...
        onEmojiColorSelected(target) {
            ...
            if (this.pnlSelectedColor) {
                ...
                const icon = this.pnlSelectedColor.querySelector('i-icon');
                if (icon)
                    icon.visible = false;
            }
        ...
        clearSearch() {
            ...
            if (this.hasRecentEmojis) {
                ...
                this.renderEmojiGroup(this.groupEmojis, emoji_json_2.emojiCategories[0]);
            }
            else if (this.recent) {
                this.recent.clearInnerHTML();
            }
            ...
            if (this.gridEmojiCate?.children?.length) {
                this.onEmojiCateSelected(this.gridEmojiCate.children[index], emoji_json_2.emojiCategories[index]);
            }
            this.pnlColors.clearInnerHTML();
        ...
        onEmojiPickerClick(target, event) {
            event.stopPropagation();
        }
        render() {
            return (this.$render("i-vstack", { position: 'relative', onClick: this.onEmojiPickerClick },
    ...
    EmojiPicker = __decorate([
        (0, components_1.customElements)('i-scom-emoji-picker')
    ], EmojiPicker);
